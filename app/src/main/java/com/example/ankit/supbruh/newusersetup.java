...
public class newusersetup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_newusersetup);
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent steupoover = new Intent(newusersetup.this,Chatlogs.class);
                startActivity(steupoover);
                finish();
            }
        });
    ...
    protected void onStart() {
        ...
        changestatus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent changestatusactivity = new Intent(newusersetup.this,Statusupdation.class);
